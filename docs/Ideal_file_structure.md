...
│   │── users/
│   │   ├── models.py          # UserProfile, Address, CustomUser (если нужно)
│   │   ├── serializers.py     # Для отображения и валидации данных
│   │   ├── views.py           # API для профиля, обновления данных
│   │   ├── urls.py            # Роутинг пользователей
│   │   ├── services.py        # Бизнес-логика (например, обновление профиля)
│   │   ├── tasks.py           # Фоновые задачи (например, отправка писем)
│   │   └── tests.py           # Покрытие тестами
